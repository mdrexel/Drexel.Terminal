...
namespace Drexel.Terminal.Text
{
    ...
    public sealed class Catena
    {
        ...
        public static Catena Empty { get; } = new Catena(string.Empty, TerminalColors.Default);
        ...
        public static implicit operator Catena(string value)
        {
            return new Catena(value, TerminalColors.Default);
        }
